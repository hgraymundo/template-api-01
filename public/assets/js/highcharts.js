  ...
  'use strict';
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#6963ff', '#ffa22b', '#21cb95', '#00bcd4', '#5e5baa', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#21cb95', '#5e5baa' ,'#00bcd4', '#6963ff', '#ffa22b' ],
		credits: {
			enabled: false
		},
		series: [{
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#21cb95', '#00bcd4', '#ffa22b' , '#6963ff', '#ff5c75' ],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
	...
	colors: ['#6963ff', '#ffa22b', '#21cb95', '#00bcd4', '#5e5baa', '#FF9655', '#f1c40f', '#6AF9C4'],
    series: [{
        type: 'column',
        colorByPoint: true,
